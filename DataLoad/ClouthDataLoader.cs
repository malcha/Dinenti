...
namespace MvcApplication2.DataLoad
{
    public class ClouthDataLoader
    {
        ...
        public static IEnumerable<Models.Clouth> GetAllXMayor()
        {
            ...
            list.Add(new Models.Clouth(8074, "TAPADO ESTAMPADO CON POLAR BEBA (ROJO)", "1 AL 5", "$ 625,00", "", "", "", "", "Varios estampados", Models.Clouth.SUBCATEGORY.REMERAS, Models.Clouth.CATEGORY.BEBAS));
            list.Add(new Models.Clouth(8075, "TAPADO ESTAMPADO CON CORDERITO BEBA (ROJO)", "1 AL 5", "$ 625,00", "", "", "", "", "Varios estampados", Models.Clouth.SUBCATEGORY.REMERAS, Models.Clouth.CATEGORY.BEBAS));
            ...
            list.Add(new Models.Clouth(8059, "ASTRONAUTA ESTAMPADO", "1 AL 3", "$ 610,00", "", "", "", "", "Varios estampados", Models.Clouth.SUBCATEGORY.REMERAS, Models.Clouth.CATEGORY.MINIBEBES, imgName: "8059-2"));
            ...
            list.Add(new Models.Clouth(8065, "CHALECO BEBA OREJAS", "1 AL 5", "$ 399,00", "", "", "", "", "Varios estampados", Models.Clouth.SUBCATEGORY.REMERAS, Models.Clouth.CATEGORY.BEBAS, imgName: "8065-4"));
            ...
            list.Add(new Models.Clouth(8074, "TAPADO ESTAMPADO CON POLAR BEBA (GRIS)", "1 AL 5", "$ 625,00", "", "", "", "", "Varios estampados", Models.Clouth.SUBCATEGORY.REMERAS, Models.Clouth.CATEGORY.BEBAS, imgName: "8074-2"));
            list.Add(new Models.Clouth(8074, "TAPADO ESTAMPADO CON POLAR BEBA (CELESTE)", "1 AL 5", "$ 625,00", "", "", "", "", "Varios estampados", Models.Clouth.SUBCATEGORY.REMERAS, Models.Clouth.CATEGORY.BEBAS, imgName: "8074-2"));
